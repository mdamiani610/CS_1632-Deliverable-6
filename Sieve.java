...
public class Sieve {
    ...
    public static void printSieve1(int[] results, boolean[] prime) {
	    System.out.print("> ");
	    char character = ' ';
		...
		character = prime[j] ? 'T' : 'F';
		System.out.print(results[j] + "(" + character + ") ");
		j++;
	    }
	    System.out.println();
    }
    ...
    public static void printSieve2(int[] results) {
    ...
    /**
     * @param value the size of the array to return.
     */
    
    public static boolean[] getTrueArray(int value) {
	boolean[] toReturn = new boolean[value];
